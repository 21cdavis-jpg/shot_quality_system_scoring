...
export declare class PieWithState extends PureComponent<InternalProps, State> {
    pieRef: SVGGElement;
    ...
    renderLabels(sectors: Readonly<PieSectorDataItem[]>): React.JSX.Element;
    renderSectorsStatically(sectors: Readonly<PieSectorDataItem[]>): React.JSX.Element;
