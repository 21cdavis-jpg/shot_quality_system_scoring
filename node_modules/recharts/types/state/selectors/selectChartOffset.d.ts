...
export declare const selectChartOffset: (state: RechartsRootState) => ChartOffset;
export declare const selectChartViewBox: ((state: import("redux").EmptyObject & {
    ...
    resultFunc: (resultFuncArgs_0: any) => CartesianViewBox;
    memoizedResultFunc: ((resultFuncArgs_0: any) => CartesianViewBox) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => CartesianViewBox;
    dependencies: [(state: RechartsRootState) => ChartOffset];
...
export declare const selectAxisViewBox: ((state: import("redux").EmptyObject & {
    ...
    resultFunc: (resultFuncArgs_0: number, resultFuncArgs_1: number) => CartesianViewBox;
    memoizedResultFunc: ((resultFuncArgs_0: number, resultFuncArgs_1: number) => CartesianViewBox) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
