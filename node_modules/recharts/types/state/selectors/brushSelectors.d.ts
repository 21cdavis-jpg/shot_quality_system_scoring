...
export declare const selectBrushSettings: (state: RechartsRootState) => import("../brushSlice").BrushSettings;
...
export declare const selectBrushDimensions: ((state: import("redux").EmptyObject & {
    ...
    legend: import("../legendSlice").LegendState;
    ...
    resultFunc: (resultFuncArgs_0: import("../brushSlice").BrushSettings, resultFuncArgs_1: any, resultFuncArgs_2: any) => {
        height: number;
        x: any;
        y: number;
        width: any;
    };
    memoizedResultFunc: ((resultFuncArgs_0: import("../brushSlice").BrushSettings, resultFuncArgs_1: any, resultFuncArgs_2: any) => {
        height: number;
        x: any;
        y: number;
        width: any;
    ...
    dependencies: [(state: RechartsRootState) => import("../brushSlice").BrushSettings, (state: RechartsRootState) => import("../../util/types").ChartOffset, (state: RechartsRootState) => import("../../util/types").Margin | undefined];
