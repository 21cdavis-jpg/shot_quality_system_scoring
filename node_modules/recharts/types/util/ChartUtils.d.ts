...
import { AxisTick, AxisType, BaseAxisProps, ChartCoordinate, ChartOffset, DataKey, LayoutType, NumberDomain, PolarViewBox, RangeObj, StackOffsetType, TickItem } from './types';
...
export declare const appendOffsetOfLegend: (offset: ChartOffset, legendState: LegendState) => ChartOffset;
...
export declare function getTooltipNameProp(nameFromItem: string | number | undefined, dataKey: DataKey<any>): string | undefined;
