...
class DefaultLegendContent extends _react.PureComponent {
  ...
  renderItems() {
    ...
    return payload.map((entry, i) => {
      ...
      var entryValue = typeof entry.value !== 'function' ? entry.value : null;
      (0, _LogUtils.warn)(typeof entry.value !== 'function', "The name property is also required when using a function for the dataKey of a chart's cartesian components. Ex: <Bar name=\"Name of my Data\"/>" // eslint-disable-line max-len
      );
      var color = entry.inactive ? inactiveColor : entry.color;
      var finalValue = finalFormatter ? finalFormatter(entryValue, entry, i) : entryValue;
