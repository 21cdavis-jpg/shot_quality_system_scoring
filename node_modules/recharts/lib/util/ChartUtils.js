...
exports.getTicksOfAxis = exports.getStackedData = exports.getDomainOfStackGroups = exports.getCoordinatesOfGrid = void 0;
...
var appendOffsetOfLegend = (offset, legendState) => {
  if (legendState) {
    var {
      size: {
        width: boxWidth,
