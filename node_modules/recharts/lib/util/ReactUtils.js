...
exports.validateWidthHeight = exports.toArray = exports.isValidSpreadableProp = exports.isChildrenEqual = exports.hasClipDot = exports.getDisplayName = void 0;
...
var hasClipDot = dot => dot && typeof dot === 'object' && 'clipDot' in dot;
...
var isValidSpreadableProp = (property, key, includeEvents, svgElementType) => {
  ...
  return typeof property !== 'function' && (svgElementType && matchingElementTypeKeys.includes(key) || _types.SVGElementPropKeys.includes(key)) || includeEvents && _types.EventKeys.includes(key);
};
...
var isSingleChildEqual = (nextChild, prevChild) => {
  if ((0, _DataUtils.isNullish)(nextChild) && (0, _DataUtils.isNullish)(prevChild)) {
    return true;
  }
  if (!(0, _DataUtils.isNullish)(nextChild) && !(0, _DataUtils.isNullish)(prevChild)) {
    var _ref2 = nextChild.props || {},
      {
        children: nextChildren
      } = _ref2,
      nextProps = _objectWithoutProperties(_ref2, _excluded);
    var _ref3 = prevChild.props || {},
      {
        children: prevChildren
      } = _ref3,
      prevProps = _objectWithoutProperties(_ref3, _excluded2);
    if (nextChildren && prevChildren) {
