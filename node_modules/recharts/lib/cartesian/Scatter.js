...
var _excluded = ["onMouseEnter", "onClick", "onMouseLeave"],
  _excluded2 = ["animationBegin", "animationDuration", "animationEasing", "hide", "isAnimationActive", "legendType", "lineJointType", "lineType", "shape", "xAxisId", "yAxisId", "zAxisId"]; // eslint-disable-next-line max-classes-per-file
...
function ScatterSymbols(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, points.map((entry, i) => {
...
function computeScatterPoints(_ref) {
  var {
    displayedData,
    xAxis,
    yAxis,
...
class ScatterWithState extends _react.PureComponent {
  ...
  renderSymbolsStatically(points) {
    return /*#__PURE__*/_react.default.createElement(ScatterSymbols, {
      points: points,
      allOtherScatterProps: this.props
    });
  }
  renderSymbolsWithAnimation() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactSmooth.default, {
      ...
      return /*#__PURE__*/_react.default.createElement(_Layer.Layer, null, this.renderSymbolsStatically(stepData));
    });
  }
  renderSymbols() {
    var {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Layer.Layer, {
      ...
      xAxisId: xAxisId,
      yAxisId: yAxisId
    })), /*#__PURE__*/_react.default.createElement(ScatterLine, this.props), /*#__PURE__*/_react.default.createElement(_CartesianGraphicalItemContext.SetErrorBarContext, {
      xAxisId: xAxisId,
      yAxisId: yAxisId,
      data: points,
