...
class RadarWithState extends _react.PureComponent {
  ...
  render() {
    ...
    }, this.renderPolygon(), (!isAnimationActive || isAnimationFinished) && _LabelList.LabelList.renderCallByParent(this.props, points)), /*#__PURE__*/_react.default.createElement(_ActivePoints.ActivePoints, {
      points: points,
