...
var createRechartsStore = exports.createRechartsStore = function createRechartsStore(preloadedState) {
  ...
  return (0, _toolkit.configureStore)({
    ...
    }).concat([_mouseEventsMiddleware.mouseClickMiddleware.middleware, _mouseEventsMiddleware.mouseMoveMiddleware.middleware, _keyboardEventsMiddleware.keyboardEventsMiddleware.middleware, _externalEventsMiddleware.externalEventsMiddleware.middleware]),
    devTools: {
      serialize: {
