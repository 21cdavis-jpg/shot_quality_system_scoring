...
class AreaWithState extends PureComponent {
  ...
  renderAreaWithAnimation(needClip, clipPathId) {
    ...
    return /*#__PURE__*/React.createElement(Animate, {
      ...
      }, this.renderClipRect(t))), /*#__PURE__*/React.createElement(Layer, {
  ...
  render() {
    ...
    }))), !hasSinglePoint ? this.renderArea(needClip, clipPathId) : null, (dot || hasSinglePoint) && this.renderDots(needClip, clipDot, clipPathId), (!isAnimationActive || isAnimationFinished) && LabelList.renderCallByParent(this.props, points)), /*#__PURE__*/React.createElement(ActivePoints, {
      points: points,
...
function AreaImpl(props) {
  ...
  var {
    ...
    isRange,
    baseLine
  } = (_useAppSelector = useAppSelector(state => selectArea(state, props.xAxisId, props.yAxisId, isPanorama, {
...
export function computeArea(_ref2) {
  var {
    areaSettings: {
      connectNulls,
