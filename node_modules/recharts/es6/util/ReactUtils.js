...
export var hasClipDot = dot => dot && typeof dot === 'object' && 'clipDot' in dot;
...
export var isValidSpreadableProp = (property, key, includeEvents, svgElementType) => {
  ...
  return typeof property !== 'function' && (svgElementType && matchingElementTypeKeys.includes(key) || SVGElementPropKeys.includes(key)) || includeEvents && EventKeys.includes(key);
};
 ...
 */
export var isChildrenEqual = (nextChildren, prevChildren) => {
