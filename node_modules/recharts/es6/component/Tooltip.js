...
function TooltipInternal(props) {
  ...
  var cursorPortal = useCursorPortal();
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/createPortal(tooltipElement, tooltipPortal), finalIsActive && /*#__PURE__*/createPortal(/*#__PURE__*/React.createElement(Cursor, {
    cursor: cursor,
...
export class Tooltip extends PureComponent {
  render() {
    return /*#__PURE__*/React.createElement(TooltipInternal, this.props);
  }
}
