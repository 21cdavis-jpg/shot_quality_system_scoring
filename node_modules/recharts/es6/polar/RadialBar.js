...
function RadialBarSectors(props) {
  var {
    sectors,
...
class RadialBarWithState extends PureComponent {
  ...
  renderSectorsStatically(sectors) {
    return /*#__PURE__*/React.createElement(RadialBarSectors, {
      sectors: sectors,
      allOtherRadialBarProps: this.props
    });
  }
  renderSectorsWithAnimation() {
    ...
    return /*#__PURE__*/React.createElement(Animate, {
      ...
      return /*#__PURE__*/React.createElement(Layer, null, this.renderSectorsStatically(stepData));
    });
  }
  renderSectors() {
    var {
...
export function computeRadialBarDataItems(_ref2) {
  var {
    displayedData,
    stackedData,
    dataStartIndex,
